...
public class TeacherDAOImpl implements ITeacherDAO {
    ...
    public Teacher insert(Teacher teacher) throws TeacherDAOException {
        ...
        try (Connection connection = DBUtil.getConnection();
            ...
            if (n >= 1) {
                JOptionPane.showMessageDialog(null, n + " row affected", "Successful Insert", JOptionPane.PLAIN_MESSAGE);
                return teacher;
            } else {
                return null;
            }
    ...
    public Teacher update(Teacher teacher) throws TeacherDAOException {
        ...
        try (Connection connection = DBUtil.getConnection();
            ...
            int n = ps.executeUpdate();
            if (n >= 1) {
                JOptionPane.showMessageDialog(null, n + " row affected", "Successful Update", JOptionPane.PLAIN_MESSAGE);
                return teacher;
            } else {
                return null;
            }
    ...
    public void delete(int id) throws TeacherDAOException {
        ...
        try (Connection connection = DBUtil.getConnection();
            ...
            if (response == JOptionPane.YES_OPTION) {
                int n = ps.executeUpdate();
                if (n >= 1) {
                    JOptionPane.showMessageDialog(null, n + " row affected", "Successful Delete", JOptionPane.PLAIN_MESSAGE);
                } else {
                    JOptionPane.showMessageDialog(null, "No rows affected", "Unsuccessful Delete", JOptionPane.PLAIN_MESSAGE);
                }
            }
        } catch (SQLException e) {
            e.printStackTrace();
